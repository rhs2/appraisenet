...
def main() -> None:
    ...
    lines += ["", "| model | family | CV MAPE | holdout MAPE | median APE | within 10% | 80% interval coverage | width (% of price) |",
              "|---|---|---|---|---|---|---|---|"]
    for _, r in res.iterrows():
        lines.append(f"| {r['model']} | {r['family']} | {r['cv_mape_pct']}% | **{r['holdout_mape_pct']}%** | "
